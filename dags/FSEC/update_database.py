...
def old_EOD_Update_FSEC_Database(): #<-- pass a logger
    """
...
# Module Status - Needs primary key
    ...
    logger.info(log)
    """
    print("Module Status - Needs primary key")
# Sinton IV
...
""" if __name__ == "__main__":
     logger = dm.create_logger() #<-- pass this logger
    old_EOD_Update_FSEC_Database()"""
